...
var enableUserTimingAPI = false; // Helps identify side effects in render-phase lifecycle hooks and setState
...
function validateResponderContext() {
  if (!(currentInstance !== null)) {
    {
      throw Error(formatProdErrorMessage(346));
    }
  }
}
...
function shim() {
  {
    {
      throw Error(formatProdErrorMessage(270));
    }
  }
    ...
    case RootSuspended:
      {
        ...
        !(false && flushSuspenseFallbacksInTests && IsThisRendererActing.current)) {
    ...
    case RootCompleted:
      {
        ...
        !(false && flushSuspenseFallbacksInTests && IsThisRendererActing.current) && workInProgressRootLatestProcessedExpirationTime !== Sync && workInProgressRootCanSuspendUsingConfig !== null) {
